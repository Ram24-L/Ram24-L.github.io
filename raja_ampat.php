				...
				<div class="col-12 col-xl-8">
					<div class="max-w-3xl mx-auto mx-xl-0 mt-4">
						...
						<div class="d-flex justify-content-between align-items-center flex-wrap">
							<div class="mt-2">
								<img src="./assets/img/team/athar_.jpg" height="40" width="40" class="img-fluid rounded-circle" alt="small team" loading="lazy">

								<span class="text-body text-sm fw-medium ps-2">
									Muhammad Athar Khairy Zhafran
								</span>
						...
						<p class="mt-4 text-body-secondary text-lg leading-8 text-justify">
							#SaveRajaAmpat – Menjaga Surga Bawah Laut untuk Generasi Mendatang
							Raja Ampat bukan sekadar destinasi wisata. Ia adalah permata Nusantara, rumah bagi lebih dari 75% spesies karang dunia dan ribuan biota laut langka. Lautannya biru jernih, pulau-pulaunya asri, dan terumbu karangnya menyimpan kekayaan hayati yang tak ternilai.
							Namun, keindahan ini kini terancam. Pencemaran laut, eksploitasi sumber daya alam, dan pariwisata yang tidak bertanggung jawab perlahan mengikis keasriannya. Setiap plastik yang dibuang sembarangan, setiap terumbu karang yang rusak, adalah ancaman nyata bagi keberlangsungan ekosistem Raja Ampat.
							Saatnya kita bertindak. Bukan hanya pemerintah atau pegiat lingkungan—tapi kita semua. Edukasi, bijak berwisata, dan mengurangi sampah adalah langkah kecil yang berdampak besar.
							Raja Ampat bukan hanya milik Papua. Ia adalah warisan dunia. Mari bersama melindunginya.
						</p>
						...
						<div class="mt-4">
							<div class="mt-5">
		                        <div class="ratio ratio-16x9" data-aos-delay="0" data-aos="fade" data-aos-duration="3000">
		                            <img src="./assets/img/bg/save-raja-ampat2.jpg" class="img-fluid object-fit-cover rounded-3" alt="presentation" loading="lazy">
		                        </div>
		                    </div>
						</div>
						...
						<div class="mt-6">
							...
							<p class="text-body-secondary text-lg leading-8 text-justify">
								Raja Ampat adalah anugerah alam yang luar biasa, bukan hanya bagi Indonesia, tetapi juga bagi dunia. Keindahan dan kekayaan hayatinya tak tergantikan. Oleh karena itu, menjaga kelestariannya adalah tanggung jawab bersama. Dengan meningkatkan kesadaran, berperilaku ramah lingkungan, dan mendukung upaya konservasi, kita bisa memastikan bahwa keindahan Raja Ampat tetap lestari untuk dinikmati oleh generasi sekarang dan masa depan.
								Jangan tunggu sampai semuanya hilang baru kita peduli. Mulailah sekarang. #SaveRajaAmpat
							</p>
						</div>
					</div>
				</div>
