				...
				<div class="col-12 col-xl-8">
					<div class="max-w-3xl mx-auto mx-xl-0 mt-4">
						...
						<p class="mt-4 text-body-secondary text-lg leading-8 text-justify">
                            8 Manfaat Hutan Tropis bagi Kehidupan
                            Hutan tropis adalah salah satu ekosistem paling penting dan paling kaya keanekaragaman hayatinya di bumi. Di Indonesia, hutan tropis tersebar di pulau-pulau besar seperti Kalimantan, Sumatera, dan Papua. Keberadaannya memberikan manfaat besar, tidak hanya untuk manusia dan satwa liar, tetapi juga bagi kestabilan iklim global. Berikut adalah 8 manfaat utama hutan tropis:<br>

                            <br>1. Penghasil Oksigen Utama
                            Hutan tropis berperan besar dalam menghasilkan oksigen melalui proses fotosintesis. Pohon-pohon besar menyerap karbon dioksida dan melepaskan oksigen yang kita butuhkan untuk bernapas.<br>
                            <br>2. Menyerap Karbon di Udara
                            Selain menghasilkan oksigen, hutan tropis juga berfungsi sebagai penyerap karbon. Ini membantu memperlambat laju perubahan iklim global.<br>
                            <br>3. Habitat Bagi Beragam Makhluk Hidup
                            Hutan tropis adalah rumah bagi jutaan spesies tumbuhan, hewan, dan mikroorganisme. Banyak di antaranya tidak ditemukan di tempat lain di dunia.<br>
                            <br>4. Sumber Obat-obatan Alami
                            Banyak tanaman yang tumbuh di hutan tropis digunakan dalam dunia medis. Sekitar 25% obat modern berasal dari tanaman hutan, termasuk untuk penyakit serius seperti kanker dan malaria.<br>
                            <br>5. Mengatur Siklus Air
                            Akar pohon di hutan tropis menyerap dan menyimpan air hujan, kemudian melepaskannya perlahan ke dalam tanah. Ini membantu mencegah banjir dan menjaga pasokan air tanah.<br>
                            <br>6. Menjaga Kesuburan Tanah
                            Daun-daunan yang gugur dan membusuk di lantai hutan menjadi pupuk alami yang menjaga kesuburan tanah secara berkelanjutan.<br>
                            <br>7. Menopang Kehidupan Suku Adat
                            Banyak masyarakat adat bergantung langsung pada hutan untuk tempat tinggal, makanan, obat-obatan, dan budaya mereka.<br>
                            <br>8. Menjadi Sumber Ekonomi
                            Jika dikelola dengan bijak, hutan bisa menjadi sumber ekonomi melalui hasil hutan non-kayu seperti madu, rotan, dan tanaman herbal, tanpa harus merusaknya.<br>
						</p>
						...
						<div class="mt-4">
							<div class="mt-5">
		                        <div class="ratio ratio-16x9" data-aos-delay="0" data-aos="fade" data-aos-duration="3000">
		                            <img src="./assets/img/bg/bg10.jpg" class="img-fluid object-fit-cover rounded-3" alt="presentation" loading="lazy">
		                        </div>
		                    </div>
						</div>
						...
						<div class="mt-6">
							...
							<p class="text-body-secondary text-lg leading-8 text-justify">
                                Hutan tropis adalah aset alam yang sangat penting bagi kehidupan di bumi. Fungsinya mencakup lingkungan, ekonomi, kesehatan, hingga budaya. Sayangnya, keberadaan hutan tropis terus terancam oleh penebangan liar, kebakaran hutan, dan ekspansi industri. Oleh karena itu, pelestarian hutan bukan hanya tugas pemerintah atau pegiat lingkungan, tetapi tanggung jawab kita semua. Dengan menjaga hutan, kita menjaga masa depan.
                                Hutan adalah nafas dunia. Mari jaga bersama. 🌿 #SaveOurForest #HutanTropisLestari
							</p>
						</div>
					</div>
				</div>
