				...
				<div class="col-12 col-xl-8">
					<div class="max-w-3xl mx-auto mx-xl-0 mt-4">
						...
						<h2 class="my-4 text-body-emphasis text-4xl tracking-tight fw-bold">
							Press Release : <br>Aksi Bersih Pantai bersama Radar 
						</h2>

						<div class="d-flex justify-content-between align-items-center flex-wrap">
							<div class="mt-2">
								<img src="./assets/img/team/ramz.jpg" height="40" width="40" class="img-fluid rounded-circle" alt="small team" loading="lazy">

								<span class="text-body text-sm fw-medium ps-2">
									Muhammad Ramdhan Maulana
								</span>
						...
						<div class="mt-5">
	                        <div class="ratio ratio-16x9" data-aos-delay="0" data-aos="fade" data-aos-duration="3000">
	                            <img src="./assets/img/bg/header.jpg" class="object-fit-cover rounded-3" alt="presentation" loading="lazy">
	                        </div>
	                    </div>

						<p class="mt-4 text-body-secondary text-lg leading-8 text-justify">
							Minggu, 18 Mei 2025. Mahasiswa Universitas Bina Sarana Informatika dari kelompok yang bernama RADAR melaksanakan kegiatan pengabdian masyarakat bertema Cinta Tanah Air di Pantai Citepus, Kabupaten Sukabumi. Kegiatan ini merupakan bagian dari tugas akhir mata kuliah Pendidikan Kewarganegaraan (PKN), dengan tujuan menumbuhkan semangat kepedulian terhadap lingkungan sebagai wujud nyata cinta terhadap tanah air.
						</p>

						<p class="text-body-secondary text-lg leading-8 text-justify">
							Kegiatan berlangsung pada Minggu pagi hingga siang dan berfokus pada penataan serta kebersihan area pantai. Beberapa aktivitas yang dilakukan antara lain memungut sampah, serta memastikan keadaan pantai menjadi lebih bersih. Kegiatan ini bertujuan untuk menumbuhkan rasa tanggung jawab mahasiswa terhadap lingkungan sekitar sebagai bagian dari nilai-nilai kebangsaan.
						</p>
						...
						<div class="mt-4">
							...
							Tidak sekadar tugas Mata Kuliah
							</h2>

							<p class="text-body-secondary text-lg leading-8 text-justify">
								kegiatan dimulai dengan meminta izin kepada pengurus setempat sehari sebelum kegiatan sekaligus meminta izin untuk berkemah diarea sisi pantai kami. Kegiatan ini dipimpin oleh mahasiswa bernama Dias Havits selaku ketua kegiatan, Muhammad Ramdhan Maulana, Muhammad Arya Dwi Anggara, Muhammad Athar Khairy Zhafran dan Muhammad Rezafs Ilham sebagai angota. Seluruh kegiatan dirancang sebagai bentuk kontribusi mahasiswa kepada lingkungan sekaligus penguatan nilai-nilai kewarganegaraan dalam praktik nyata di masyarakat.
							</p>

							<div class="mt-5">
		                        <div class="ratio ratio-16x9" data-aos-delay="0" data-aos="fade" data-aos-duration="3000">
		                            <img src="./assets/img/bg/radar3.jpg" class="img-fluid object-fit-cover rounded-3" alt="presentation" loading="lazy">
		                        </div>
		                    </div>
						</div>
						...
						<div class="mt-4">
							<h2 class="mb-3 text-body-emphasis tracking-tight text-3xl fw-semibold">
								Aksi Baur Masyarakat
							</h2>

							<p class="text-body-secondary text-lg leading-8 text-justify">
								kegiatan ini tidak hanya sebatas bersih-bersih pantai, namun juga menjadi ajang edukasi tentang pentingnya menjaga lingkungan pantai sebagai bagian dari rasa memiliki terhadap bangsa dan negara. Program pengabdian masyarakat ini diharapkan menjadi langkah kecil yang memberikan dampak besar bagi kesadaran masyarakat tentang pentingnya menjaga lingkungan. Universitas Bina Sarana Informatika mendukung penuh keterlibatan mahasiswa dalam aksi-aksi nyata yang membawa manfaat bagi masyarakat luas.

							</p>

							<div class="mt-5">
		                        <div class="ratio ratio-16x9" data-aos-delay="0" data-aos="fade" data-aos-duration="3000">
		                            <img src="./assets/img/bg/kesimpulan.jpg" class="img-fluid object-fit-cover rounded-3" alt="presentation" loading="lazy">
		                        </div>
		                    </div>
						</div>
						...
						<div class="mt-6">
							...
							<p class="text-body-secondary text-lg leading-8 text-justify">
								Kami mendapat kesimpulan bahwa, membersihkan pantai tidak hanya berkontribusi menyelamatkan ekosistem laut saja, tetapi ekossitem darat juga terkena dampak baiknya, juga, kami sebagai mahasiswa harus memberikan dampak kepada masyarakat luas.
							</p>
						</div>
					</div>
				</div>
