			...
			<div class="row justify-content-center">
				<div class="col-12 col-md-6 col-xl-4" data-aos-delay="0" data-aos="fade-left" data-aos-duration="3000">
					<div class="d-flex mt-4 mb-3 p-3 p-lg-4 align-items-center bg-body-tertiary shadow rounded-4">
						<div class="p-4 home-text bg-primary rounded-circle">
						...
						<div class="ps-3">
							...
							<div class="text-body leading-6 text-sm ">
								Jawa Barat, Kota Bogor, Bogor Tengah, Babakan
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="row gy-5 gx-sm-5">
                   ...
                   <div class="mx-auto max-w-2xl mt-6">
                        <form class="row g-4 needs-validation" id="myForm" novalidate action="send_email.php" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" style="border: 1px solid gray;" class="form-control form-control-sm" name="subjectForm" id="subjectForm" required placeholder="Subject">
                                <div class="invalid-feedback text-xs">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control form-control-sm" name="messageForm" id="messageForm"  style="border: 1px solid gray;" rows="3" placeholder="Your Messages......."></textarea>
                                <div class="invalid-feedback text-xs">
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="gridCheck"  style="border: 1px solid gray;" required>
                ...
                <div class="col-12 col-xl-7 pt-7 pt-xl-0" style="min-height: 450px;">
                    <div class="h-100 position-relative ms-xxl-5">
                        <iframe class="position-absolute top-0 end-0 bottom-0 start-0 w-100 h-100 rounded-3" src="https://maps.google.com/maps?q=Taman%20Kencana%20Bogor&t=&z=15&ie=UTF8&iwloc=&output=embed" > </iframe>
                    </div>
                </div>
            </div>
        </div>
